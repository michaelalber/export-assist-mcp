...
pytest tests/test_tools/test_regulations.py::TestSearchEar

# Run a specific test method
pytest tests/test_tools/test_regulations.py::TestSearchEar::test_returns_results

# Run with coverage
pytest --cov=src/export_control_mcp
```
