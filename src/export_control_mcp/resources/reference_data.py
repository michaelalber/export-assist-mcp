...
def get_usml_category(category: int | str) -> USMLCategory | None:
    ...
    if data:
        ...
        usml.items = [
            USMLItem(designation=item[0], description=item[1])
...
COUNTRY_GROUPS: dict[str, dict] = {
    "A:1": {
        ...
        "countries": [
            ...
            "New Zealand", "Norway", "Poland", "Portugal", "Romania", "Slovakia",
    ...
    "A:5": {
        ...
        "countries": [
            "Belarus", "Burma", "China", "Cuba", "Iran", "North Korea",
            "Russia", "Syria", "Venezuela",
        ],
    },
    "A:6": {
        "name": "NATO Members",
    ...
    "D:1": {
        ...
        "countries": [
            "Afghanistan", "Armenia", "Azerbaijan", "Belarus", "Burma", "Cambodia",
            "China", "Cyprus", "Egypt", "Georgia", "Hong Kong", "India", "Iraq",
            "Israel", "Jordan", "Kazakhstan", "Kuwait", "Laos", "Lebanon", "Libya",
            "Macau", "Moldova", "Mongolia", "Oman", "Pakistan", "Qatar",
            "Russia", "Saudi Arabia", "Tajikistan", "Turkmenistan",
    ...
    "D:2": {
        ...
        "countries": [
            "Afghanistan", "Algeria", "Armenia", "Azerbaijan", "Belarus", "Burma",
            "China", "Georgia", "India", "Iraq", "Israel", "Jordan", "Kazakhstan",
            "Lebanon", "Libya", "Macau", "Moldova", "Mongolia", "North Korea",
            "Pakistan", "Russia", "Syria", "Tajikistan", "Turkmenistan",
    ...
    "D:3": {
        ...
        "countries": [
            "Armenia", "Azerbaijan", "Belarus", "Burma", "Cambodia", "China",
            "Georgia", "Iraq", "Kazakhstan", "Laos", "Moldova", "Mongolia",
            "North Korea", "Pakistan", "Russia", "Syria", "Tajikistan",
    ...
    "D:4": {
        ...
        "countries": [
            ...
            "Georgia", "India", "Iran", "Iraq", "Israel", "Kazakhstan", "Libya",
            "Moldova", "Mongolia", "North Korea", "Pakistan", "Russia", "Syria",
